...
private:
	...
	enum enTransactionsMenueOptions {
		...
		eShowTotalBalance = 3,eTransfer = 4 , eShowTransfersLog = 5,  eShowMainMenue = 6
	};
	...
	static void _ShowTransferLogSceen()
	{
		clsTransfersLogScreen::ShowRegiterList();
		system("pause>0");
	}
